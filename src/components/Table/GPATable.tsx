...
const GPATable = () => {
  ...
  return (
    <div className='px-3 lg:px-10'>
      ...
      <div className="card">
            <DataTable value={results} size='small' className='text-sm' removableSort stripedRows scrollable scrollHeight="400px" resizableColumns  tableStyle={{ minWidth: '50rem' }} emptyMessage="No semeter results added yet.">
