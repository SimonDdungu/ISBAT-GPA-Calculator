    ...
    <header className='sticky top-0 z-999 w-full bg-white'>
        <div className='py-4 px-5 flex flex-row justify-between items-center relative shadow-sm'>
            ...
            <div className='hidden lg:flex flex-row gap-x-10 text-sm'>
                ...
                <Link target='_blank' href={'https://erp.isbatuniversity.ac.ug/frmStudentLogin.aspx'} className='px-5 py-2 bg-blue-100 text-blue-900  rounded-lg flex gap-x-3 items-center hover:bg-blue-200 transition-colors'>
                    <i className='pi pi-user'></i>
                    <span>Student Portal</span>
                </Link>

                <Link target='_blank' href={'https://ilearn.isbatuniversity.ac.ug/login'} className='px-5 py-2 bg-blue-900 text-white rounded-lg flex gap-x-3 items-center hover:bg-blue-800 transition-colors'>
            ...
            {/* Mobile Nav */}
            <div ref={Mobile_Menu} className={`lg:hidden flex flex-col gap-y-5 h-60 shadow-sm text-sm absolute top-full left-0 right-0 bg-white/90 ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"} transition duration-150  p-5`}>
                ...
                <Link target='_blank' href={'https://erp.isbatuniversity.ac.ug/frmStudentLogin.aspx'} className='w-60 px-5 py-2 bg-blue-100 text-blue-900  rounded-lg flex gap-x-3 items-center hover:bg-blue-200 transition-colors'>
                    <i className='pi pi-user'></i>
                    <span>Student Portal</span>
                </Link>

                <Link target='_blank' href={'https://ilearn.isbatuniversity.ac.ug/login'} className='w-60 px-5 py-2 bg-blue-900 text-white rounded-lg flex gap-x-3 items-center hover:bg-blue-800 transition-colors'>
                    <i className='pi pi-book'></i>
                    <span>iLearn Portal</span>
                </Link>
