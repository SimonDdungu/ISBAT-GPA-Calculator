...
import { addResults} from '@/redux/slice';

interface AddSemResults {
    id: string;
    //onAdd: (newResults: any) => void;
}

const AddResults = ({id}: AddSemResults) => {
    ...
    const handleSubmit = (values: GpaAttributesForm) => {
        ...
        dispatch(addResults({id, results: validResults}))
